...
# Process and Render Dashboard if data is uploaded
if uploaded_sales is not None and uploaded_master is not None:
    ...
    st.info("👋 Welcome! Please upload 'retail_weekly_sales.xlsx' and 'store_master.xlsx' in the sidebar to populate the interactive dashboard analytics.")
